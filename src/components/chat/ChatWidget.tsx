...
const CONVERSATION_STEPS: Record<string, ConversationStep> = {
  "start": {
    ...
    messages: [
      ...
      {
        content: "I'm Wuor Bhang, Bhang's personal AI assistant. Good to see you... uhmm",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "story-mode": {
    ...
    messages: [
      {
        content: "What side of Bhang's life would you like us to discuss?",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "general-life": {
    ...
    messages: [
      {
        content: "Wuor Bhang is passionate about technology and innovation. Outside of work, he enjoys exploring new tech trends, contributing to open source projects, and sharing knowledge with the tech community.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "general-life-more": {
    ...
    messages: [
      ...
      {
        content: "Bhang believes in continuous learning and personal growth. He balances his technical pursuits with interests in design thinking and user experience. His approach to problem-solving combines analytical thinking with creative solutions.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "hobbies": {
    ...
    messages: [
      {
        content: "Outside of coding and design, Bhang enjoys photography, reading tech blogs, and experimenting with new gadgets. He's also passionate about fitness and occasionally goes hiking to disconnect and recharge.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "hobbies-more": {
    ...
    messages: [
      {
        content: "Bhang is also interested in digital minimalism and finding ways technology can enhance rather than distract from meaningful experiences. He enjoys attending tech meetups and conferences to network with like-minded professionals.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "aspirations": {
    ...
    messages: [
      {
        content: "Bhang aspires to create technology that makes a positive impact on people's lives. He's passionate about building accessible, user-friendly applications that solve real problems.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "design-process": {
    ...
    messages: [
      {
        content: "Bhang follows a user-centered design process that begins with research and understanding user needs. He creates personas, user flows, and wireframes before moving to high-fidelity designs. He believes in iterative design with regular user testing to refine the experience.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "design-tools": {
    ...
    messages: [
      {
        content: "For UI/UX design, Bhang primarily uses Figma for collaborative design work. He's also proficient with Adobe XD, Sketch, and prototyping tools like ProtoPie. For user research and testing, he works with tools like Hotjar and UserTesting.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "web-development": {
    ...
    messages: [
      {
        content: "Bhang excels in web development with proficiency in React, TypeScript, and modern front-end frameworks. He builds responsive, accessible, and performant web applications with clean, maintainable code. His development approach emphasizes component-based architecture and efficient state management.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "frontend-tech": {
    ...
    messages: [
      {
        content: "Bhang specializes in React.js ecosystem with TypeScript for type safety. He's experienced with state management solutions like Redux and Zustand, and styling approaches including Styled Components and Tailwind CSS. He stays current with modern build tools and performance optimization techniques.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "dev-philosophy": {
    ...
    messages: [
      {
        content: "Bhang believes in writing clean, maintainable code that solves real problems. He values accessibility and performance as core aspects of development, not afterthoughts. He approaches projects iteratively, focusing on delivering working software that can be continuously improved.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "sdlc-management": {
    ...
    messages: [
      {
        content: "Bhang understands the full software development lifecycle, from initial requirements gathering through deployment and maintenance. He's experienced with agile methodologies and version control systems like Git, ensuring efficient collaboration on projects of all sizes.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "project-management": {
    ...
    messages: [
      {
        content: "Bhang has experience with agile project management, particularly Scrum and Kanban methodologies. He's comfortable working with tools like Jira and Trello for task tracking and appreciates the importance of clear communication in team settings.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "cicd-practices": {
    ...
    messages: [
      {
        content: "Bhang implements continuous integration and deployment practices using tools like GitHub Actions and Jenkins. He values automated testing and believes in building robust pipelines that maintain code quality while enabling fast, reliable deployments.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "sandbox-mode": {
    ...
    messages: [
      {
        content: "In Sandbox mode, you can ask me anything about Bhang's portfolio, skills, or projects. What would you like to know?",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "sandbox-response": {
    ...
    messages: [
      {
        content: "Thanks for your question! Bhang has expertise in React, TypeScript, Tailwind CSS, and UI/UX design. You can see examples of his work in the projects section of this portfolio. For more specific details, feel free to reach out directly via the contact form.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "ask-projects": {
    ...
    messages: [
      {
        content: "Bhang has worked on various projects including responsive web applications, UI/UX redesigns, and interactive dashboards. His portfolio showcases his ability to combine aesthetic design with functional implementation.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "ask-skills": {
    ...
    messages: [
      {
        content: "Bhang's technical skills include React.js, TypeScript, CSS/SCSS, Tailwind CSS, and various UI component libraries. He's proficient in version control with Git and familiar with CI/CD pipelines.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "action-mode": {
    ...
    messages: [
      {
        content: "In Action mode, you can directly navigate to different sections of Bhang's portfolio. Where would you like to go?",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
  ...
  "pricing-mode": {
    ...
    messages: [
      {
        content: "You're interested in website pricing? Great! Bhang offers various website solutions at competitive rates in Kenyan Shillings (KES).",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "contact-pricing": {
    ...
    messages: [
      ...
      {
        content: "Bhang offers personalized quotes based on your specific requirements. Each project is unique and may require different features and timelines.",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      },
  ...
  "end-conversation": {
    ...
    messages: [
      {
        content: "Thank you for chatting! Feel free to reach out again if you have any questions about Bhang's work, skills or pricing. Have a great day!",
        timestamp: new Date(),
        sender: "admin",
        status: "read",
      }
            ...
            <div className="flex items-center gap-2">
              <div className="relative">
                <div className="h-10 w-10 rounded-full overflow-hidden">
                  <img src="/myPic.jpg" alt="Wuor Bhang" className="h-full w-full object-cover" />
                </div>
                <span className="absolute bottom-0 right-0 h-3 w-3 rounded-full bg-green-500 border-2 border-background"></span>
              </div>
              <div>
                <h3 className="font-medium">Wuor Bhang</h3>
                <p className="text-xs text-muted-foreground">Bhang's personal assistant</p>
              </div>
            </div>
          </div>
