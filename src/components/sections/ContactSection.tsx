                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center">
                    <div>
                      ...
                      <a 
                        href="mailto:uhuribhang211@gmail.com" 
                        className="text-sm text-primary hover:underline"
                        aria-label="Send email to uhuribhang211@gmail.com"
                      >
                        uhuribhang211@gmail.com
                      </a>
                    </div>
                    <CopyEmailButton email="uhuribhang211@gmail.com" />
                  </div>
                </div>
