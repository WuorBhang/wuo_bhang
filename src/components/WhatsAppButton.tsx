...
const WhatsAppButton = ({ 
  phoneNumber, 
  message = "Hi Wuor Bhang! I love your portfolio and would like to discuss a potential project. Are you available?",
  testimonialCount = 25
}: WhatsAppButtonProps) => {
  ...
  const handleClick = () => {
    ...
    const whatsappUrl = `https://wa.me/${+254700797210}?text=${encodeURIComponent(message)}`;
